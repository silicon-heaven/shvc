 ...
 * provided by the user with @ref rpchandler_file_list structure and
 ...
 * by @ref rpchandler_file_cb structure. The user should implement these
 * callbacks properly.
 *
...
struct rpchandler_file_cb {
	 ...
	 *
	 * The function is expected to allocate @ref rpchandler_file_list
	 ...
	 * @returns The pointer to @ref rpchandler_file_list structure.
	 */
...
/*! Free all resources occupied by @ref rpchandler_file_t.
 *
 * This is destructor for the object created by @ref rpchandler_file_new.
 *
 * @param handler: RPC File Handler object.
 */
