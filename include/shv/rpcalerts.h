 ...
 * :param alert: The pointer to :c:struct:`rpcalerts` structure.
 ...
 *   the returned alert.
 * :return: Pointer to the :c:struct:`rpcalerts` structure or ``NULL`` in
 *   case of an unpack error. You can investigate ``item`` to identify the
 *   failure cause.
 */
[[gnu::nonnull]]
