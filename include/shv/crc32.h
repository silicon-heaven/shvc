 ...
 *
 * :return: The initialization value for CRC32 state.
 */
 ...
 *
 * This combines :c:func:`crc32_init`, :c:func:`crc32_update`, and
 * :c:func:`crc32_finalize` in a single package.
 *
 * :param data: Pointer to the bytes CRC should be calculated for.
 * :param len: Number of bytes CRC should be calculated for.
