...
static const struct {
	...
	{{.type = CPITEM_DECIMAL, .as.Decimal = (struct cpdecimal){.mantissa = 223}},
		"223."},
	{{.type = CPITEM_DECIMAL,
		 .as.Decimal = (struct cpdecimal){.mantissa = 223, .exponent = -1}},
		"22.3"},
	{{.type = CPITEM_DECIMAL,
		 .as.Decimal = (struct cpdecimal){.mantissa = 223, .exponent = 3}},
		"223000."},
	{{.type = CPITEM_DECIMAL,
		 .as.Decimal = (struct cpdecimal){.mantissa = 223, .exponent = -5}},
		"0.00223"},
	{{.type = CPITEM_DECIMAL,
		 .as.Decimal = (struct cpdecimal){.mantissa = 223, .exponent = 7}},
		"223e7"},
	{{.type = CPITEM_DECIMAL,
		 .as.Decimal = (struct cpdecimal){.mantissa = 223, .exponent = -12}},
		"223e-12"},
